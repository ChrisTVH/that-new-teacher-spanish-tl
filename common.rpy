# TODO: Translation updated at 2025-03-10 18:57
...
translate spanish strings:
    ...
    new "habilitar auto voz"

    # renpy/common/00preferences.rpy:440
    old "self voicing disable"
    new "deshabilitar auto voz"
    ...
    new "Editor de Burbujas de Texto"
    ...
    new "Forzar el Renderizador GL2"
    ...
    new "Los cambios se ejecutarán la próxima vez que se abra este programa."
    ...
    new "Este ordenador está usando software de renderizado."
    ...
    new "Es posible que sus controladores gráficos estén desactualizados o no funcionen correctamente. Esto puede provocar una visualización de los gráficos lenta o incorrecta."

    # renpy/common/00gltest.rpy:259
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "El archivo {a=edit:1:log.txt}log.txt{/a} puede contener información que le ayudará a determinar qué está mal en su ordenador."
    ...
    new "Seleccione el Mando a Calibrar"
    ...
    new "Intenta retroceder a un momento anterior, lo que te permite guardar o elegir una opción diferente."
    ...
    new "Ignora la excepción, permitiendote continuar."

    # renpy/common/_errorhandling.rpym:737
    old "Ignores the exception, allowing you to continue. This often leads to additional errors."
    new "Ignora la excepción, permitiendote continuar. Esto suele provocar errores adicionales."
